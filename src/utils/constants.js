...
const HELLO_TEXT_SUBTITLE =
  "Быстрые цифровые решения для вашего бизнеса";

const TEAM_TEXT_ONE =
  "Мы рады предложить вам услуги нашей молодой, но опытной команды разработчиков по созданию уникальных и качественных сайтов и сервисов под заказ.";

const WELCOME_TEXT_ONE =
  "Добро пожаловать в мир профессиональных IT-решений!";
const WELCOME_TEXT_TWO =
  "Мы — команда экспертов, готовых преобразить ваш онлайн-опыт.";
const WELCOME_TEXT_THREE =
...
const URL_WHATSAPP =
  "https://api.whatsapp.com/send/?phone=74993227668";
const URL_TELEGRAM =
  "https://t.me/FastDigitalDecisions";
...
const bannerText = [
  {
    title:
      "Ваш успех — наша цель! Ваш бизнес — наше вдохновение!",
    id: "Success",
  },
  {
...
const gridText = [
  {
    ...
    description:
      "Наша команда состоит из опытных и талантливых программистов, дизайнеров, верстальщиков и маркетологов, готовых воплотить в жизнь самые смелые идеи и решения.",
  },
  {
    title: "Индивидуальный подход:",
    description:
      "Мы всегда учитываем пожелания и требования каждого клиента, чтобы создать продукт, максимально соответствующий его потребностям и целям.",
  },
  {
    title: "Гибкие тарифы и условия:",
    description:
      "Мы предлагаем широкий спектр услуг и возможностей, а также гибкие тарифы и схемы сотрудничества, чтобы каждый клиент мог выбрать наиболее подходящий вариант.",
  },
  {
    title: "Оперативность и качество:",
    description:
      "Мы гарантируем своевременное выполнение работ и высокий уровень качества, благодаря чему ваш бизнес получит мощный инструмент для развития и роста.",
  },
  {
    title: "Техническая поддержка:",
    description:
      "После завершения проекта мы предоставляем техническую поддержку, чтобы ваш сайт или сервис функционировал без сбоев и проблем.",
  },
];
